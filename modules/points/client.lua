...
CreateThread(function()
    while true do
        ...
        local newPoints = Jet.Grid.GetNearbyEntries(coords, function(entry) return entry.remove == removePoint end) --[[@as CPoint[] ]]
...
function Module.New(...)
    ...
    Jet.Grid.AddEntry(self)
    points[id] = self

    return self
end

function Module.GetAllPoints() return points end

function Module.GetNearbyPoints() return nearbyPoints end

---@return CPoint?
function Module.GetClosestPoint() return closestPoint end
